...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    // YOUTUBE
    Route::get('/youtubes/channel-info', [YouTubeController::class, 'getChannelInfo']);
    Route::get('/youtubes/channel-videos', [YouTubeController::class, 'getChannelVideos']);
    
    Route::post('/youtubes/check-service-account', [YouTubeController::class, 'checkServiceAccount'])->name('youtubes.check-service-account');
    
    Route::post('/youtubes/get-auth-url', [YouTubeController::class, 'getAuthUrl'])->name('youtubes.get-auth-url');
    Route::get('/youtubes/callback', [YouTubeController::class, 'handleCallback'])->name('youtubes.callback');
